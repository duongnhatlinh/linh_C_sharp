...
{
    public class FilesPersonalController : Controller
    {
        private readonly hethongquanlyluutrufileContext _context;
        public INotyfService _notyfService { get; }
        public FilesPersonalController(hethongquanlyluutrufileContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        {
            var url = $"/FilesPersonal/Index?typeFileID={typeFileID}";
            if (typeFileID == 0)
            {
               url = $"/FilesPersonal/Index";
            }
